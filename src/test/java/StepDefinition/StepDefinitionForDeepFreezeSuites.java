...
public class StepDefinitionForDeepFreezeSuites extends BaseClass {
    ...
    public void click_on_deep_freeze_product_winselect() {
        ...
        log.info("Clicked on DeepFreeze Product - WINSELECT.");
        ExtentReportManager.logStep(Status.INFO, "Clicked on DeepFreeze Product - WINSELECT.");
    }
    ...
    public void click_on_enable_product_dropdown() {
        ...
        log.info("Clicked on Enable product dropdown.");
        ExtentReportManager.logStep(Status.INFO, "Clicked on Enable product dropdown.");
    }
