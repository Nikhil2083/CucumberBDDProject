...
public class InstallAgentOnVM {

	public static void main(String[] args) {

		String vmName = "Windows1124H264Bit"; // VM Name
		String exeName = "FaronicsDeployAgent_Nik-RP.exe"; // Executable file name
		...
		try {
			...
			runCommand(new String[] { vboxManagePath, "startvm", vmName, "--type", "headless" });
			...
			String[] command = { vboxManagePath, "guestcontrol", vmName, "run", "--exe",
					"C:\\\\Windows\\\\System32\\\\WindowsPowerShell\\\\v1.0\\\\powershell.exe", "--username", username,
					"--password", password, "--", "-Command", "Start-Process '" + targetPath + "' -Wait" };
